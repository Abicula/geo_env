...
# --------------------------------------------------------------------------
    ...
    def dynamic(self):
		...
		# Added by Abi - used for sensitivity analysis [SF] 
        # Intended modification (scale the prec with a factor)
        self.var.Precipitation = self.var.Precipitation * self.var.prec_SF
        ...
        # Added by Abi - used for sensitivity analysis
        # Intended code - scale the Tavg by a factor
        self.var.Tavg = self.var.Tavg * self.var.Tavg_SF
